...
| `window_event_cb` | [WindowEventCallback](/guides/reference/data-structures#windoweventcallback) | 窗口事件回调函数 |
| `page_load_cb` | [WindowEventCallback](/guides/reference/data-structures#windoweventcallback) | 页面加载事件回调函数 |
| `file_drop_cb` | [WindowEventCallback](/guides/reference/data-structures#windoweventcallback) | 文件拖放事件回调函数 |
